...
Reading a pool's parameters is nine calls, and a tenth and eleventh for
the two that have a second spelling. Sent one at a time against a public
endpoint on the other side of the world, that is eleven round trips for a
panel nobody wants to wait for -- and eleven chances to be rate-limited.
